...
int main() {
    ...
    WeightLoader wl(
        "/Users/njain/experiment/tinyLLM/resources/Llama-3.2-1B-Instruct-F16.gguf", 
        Mode::ChunkedFullyResident);
    ...
    HashMapTokenizer tok(
        "/Users/njain/experiment/tinyLLM/resources/llama_tokens.txt",
        "/Users/njain/experiment/tinyLLM/resources/llama_merges.txt");

    auto tokens = tok.tokenize("Hello world");
    DEBUG_LOG("Tokenization for Hello world");
