...
TEST(TokenizerTest, NumbersOnly) {
  ...
  std::vector<int> actual =
      tok.tokenize("12309393482090582798123093934820905827983123093934820905827"
...
TEST(TokenizerTest, AmbiguousCase) {
  ...
  1. Token matching can be ambiguous, and we need to disambiguate not by longest
  prefix but by lowest rank.
