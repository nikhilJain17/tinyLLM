...
void random_test(std::string model_filepath, std::string tensor_name_filepath, bool fully_resident) {
...
void layer_by_layer_test(std::string model_filepath, std::string tensor_name_filepath, bool fully_resident) {
    std::vector<std::string> tensor_names = load_tensor_names(tensor_name_filepath);
    std::chrono::high_resolution_clock clock;
    auto start = clock.now();
    WeightLoader w(model_filepath, fully_resident);
