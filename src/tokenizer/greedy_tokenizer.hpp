...
/**
 * This is a naive tokenizer which greedily does a substring match and hashmap
 lookup to match tokens.
 * This is the baseline to measure performance improvements.
 * It also highlights correctness pitfalls when tokenizing a byte-pair encoding
 based vocabulary.
...
class GreedyTokenizer : public Tokenizer {
  ...
  private:
	...
	// TODO: (experiment) try other token vocabularies of different sizes and
	// measure token/s
