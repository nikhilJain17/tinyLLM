...
int main() {
    ...
    std::cout << "\n_________________\nPerformance\n";
    std::cout << "Loading tokens: " << std::chrono::duration_cast<std::chrono::milliseconds>(loaded_tokens - start) << "\n";
    std::cout << "Tokenizing: " << std::chrono::duration_cast<std::chrono::milliseconds>(tokenized - loaded_tokens) << "\n";
    return 0;
}